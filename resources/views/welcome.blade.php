...
<body>
    <svg id="monkey_404" viewBox="0 0 800 480">
        ...
        <g id="number_4">
            <path id="number_4_outline" class="st13"
            ...
            <path id="number_4_dots" class="st9"
